...
GeometryPass::GeometryPass(DXApp* appPtr, ComPtr<ID3DBlob> vertShader, ComPtr<ID3DBlob> pixelShader)
...
{
	//Geometry pass use these uniform values
    ...
    rootParameters[2].InitAsConstants(sizeof(MaterialData), 2);
