...
SkeletalMesh::SkeletalMesh(DXApp* dxApp, std::vector<SkeletalVertex> input_vertices, std::vector<UINT> input_indices,
	CommandList& commandList)
		:mApp(dxApp), mSkeletalVertices(std::move(input_vertices)), mIndices(std::move(input_indices)), mVertexBuffer(dxApp), mIndexBuffer(dxApp),
